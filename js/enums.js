...
UPDATETYPE.CREATE_OBJECT        = 2;
UPDATETYPE.CREATE_OBJECT2       = 3;
UPDATETYPE.OUT_OF_RANGE_OBJECTS = 4;
UPDATETYPE.NEAR_OBJECTS         = 5;

var UPDATEFLAG ={};
UPDATEFLAG.NONE         = 0x0000;
UPDATEFLAG.SELF         = 0x0001;
UPDATEFLAG.TRANSPORT    = 0x0002;
UPDATEFLAG.HAS_TARGET   = 0x0004;
UPDATEFLAG.LOWGUID      = 0x0008;
UPDATEFLAG.HIGHGUID     = 0x0010;
UPDATEFLAG.LIVING       = 0x0020;
UPDATEFLAG.HAS_POSITION = 0x0040;
UPDATEFLAG.VEHICLE      = 0x0080;
UPDATEFLAG.POSITION     = 0x0100;
UPDATEFLAG.ROTATION     = 0x0200;

var OBJECTTYPE = {};
OBJECTTYPE.OBJECT         = 1;
OBJECTTYPE.ITEM           = 2;
OBJECTTYPE.CONTAINER      = 6; // a container is ALWAYS an item!
OBJECTTYPE.UNIT           = 8;
OBJECTTYPE.PLAYER         = 16;
OBJECTTYPE.GAMEOBJECT     = 32;
OBJECTTYPE.DYNAMICOBJECT  = 64;
OBJECTTYPE.CORPSE         = 128;
OBJECTTYPE.AIGROUP        = 256;
OBJECTTYPE.AREATRIGGER    = 512;

var OBJECTTYPEID ={};
OBJECTTYPEID.OBJECT        = 0;
OBJECTTYPEID.ITEM          = 1;
OBJECTTYPEID.CONTAINER     = 2;
OBJECTTYPEID.UNIT          = 3;
OBJECTTYPEID.PLAYER        = 4;
OBJECTTYPEID.GAMEOBJECT    = 5;
OBJECTTYPEID.DYNAMICOBJECT = 6;
OBJECTTYPEID.CORPSE        = 7;
OBJECTTYPEID.AIGROUP       = 8;
OBJECTTYPEID.AREATRIGGER   = 9;
OBJECTTYPEID.MAX           = OBJECTTYPEID.AREATRIGGER;

var MOVEMENTFLAG = {};
MOVEMENTFLAG.NONE               = 0x00000000;
MOVEMENTFLAG.FORWARD            = 0x00000001;
MOVEMENTFLAG.BACKWARD           = 0x00000002;
MOVEMENTFLAG.STRAFE_LEFT        = 0x00000004;
MOVEMENTFLAG.STRAFE_RIGHT       = 0x00000008;
MOVEMENTFLAG.TURN_LEFT          = 0x00000010;
MOVEMENTFLAG.TURN_RIGHT         = 0x00000020;
MOVEMENTFLAG.PITCH_UP           = 0x00000040;
MOVEMENTFLAG.PITCH_DOWN         = 0x00000080;
MOVEMENTFLAG.WALK_MODE          = 0x00000100;               // Walking
MOVEMENTFLAG.ONTRANSPORT        = 0x00000200;
MOVEMENTFLAG.LEVITATING         = 0x00000400;
MOVEMENTFLAG.ROOT               = 0x00000800;
MOVEMENTFLAG.FALLING            = 0x00001000;
MOVEMENTFLAG.FALLINGFAR         = 0x00002000;
MOVEMENTFLAG.PENDINGSTOP        = 0x00004000;
MOVEMENTFLAG.PENDINGSTRAFESTOP  = 0x00008000;
MOVEMENTFLAG.PENDINGFORWARD     = 0x00010000;
MOVEMENTFLAG.PENDINGBACKWARD    = 0x00020000;
MOVEMENTFLAG.PENDINGSTRAFELEFT  = 0x00040000;
MOVEMENTFLAG.PENDINGSTRAFERIGHT = 0x00080000;
MOVEMENTFLAG.PENDINGROOT        = 0x00100000;
MOVEMENTFLAG.SWIMMING           = 0x00200000;               // appears with fly flag also
MOVEMENTFLAG.ASCENDING          = 0x00400000;               // swim up also
MOVEMENTFLAG.DESCENDING         = 0x00800000;               // swim down also
MOVEMENTFLAG.CAN_FLY            = 0x01000000;               // can fly in 3.3?
MOVEMENTFLAG.FLYING             = 0x02000000;               // Actual flying mode
MOVEMENTFLAG.SPLINE_ELEVATION   = 0x04000000;               // used for flight paths
MOVEMENTFLAG.SPLINE_ENABLED     = 0x08000000;               // used for flight paths
MOVEMENTFLAG.WATERWALKING       = 0x10000000;               // prevent unit from falling through water
MOVEMENTFLAG.SAFE_FALL          = 0x20000000;               // active rogue safe fall spell (passive)
MOVEMENTFLAG.HOVER              = 0x40000000;

var MOVEMENTFLAG2 = {};
MOVEMENTFLAG2.NONE              = 0x0000;
MOVEMENTFLAG2.UNK1              = 0x0001;
MOVEMENTFLAG2.UNK2              = 0x0002;
MOVEMENTFLAG2.UNK3              = 0x0004;
MOVEMENTFLAG2.FULLSPEEDTURNING  = 0x0008;
MOVEMENTFLAG2.FULLSPEEDPITCHING = 0x0010;
MOVEMENTFLAG2.ALLOW_PITCHING    = 0x0020;
MOVEMENTFLAG2.UNK4              = 0x0040;
MOVEMENTFLAG2.UNK5              = 0x0080;
MOVEMENTFLAG2.UNK6              = 0x0100;
MOVEMENTFLAG2.UNK7              = 0x0200;
MOVEMENTFLAG2.INTERP_MOVEMENT   = 0x0400;
MOVEMENTFLAG2.INTERP_TURNING    = 0x0800;
MOVEMENTFLAG2.INTERP_PITCHING   = 0x1000;
MOVEMENTFLAG2.UNK8              = 0x2000;
MOVEMENTFLAG2.UNK9              = 0x4000;
...
SPLINEFLAG.Falling      = 0x00000002;           // Affects elevation computation
SPLINEFLAG.Unknown3     = 0x00000004;
SPLINEFLAG.Unknown4     = 0x00000008;
SPLINEFLAG.Unknown5     = 0x00000010;
SPLINEFLAG.Unknown6     = 0x00000020;
SPLINEFLAG.Unknown7     = 0x00000040;
SPLINEFLAG.Unknown8     = 0x00000080;
SPLINEFLAG.Runmode      = 0x00000100;
SPLINEFLAG.Flying       = 0x00000200;           // Smooth movement(Catmullrom interpolation mode); flying animation
SPLINEFLAG.No_Spline    = 0x00000400;
SPLINEFLAG.Unknown12    = 0x00000800;
SPLINEFLAG.Unknown13    = 0x00001000;
SPLINEFLAG.Unknown14    = 0x00002000;
SPLINEFLAG.Unknown15    = 0x00004000;
SPLINEFLAG.Unknown16    = 0x00008000;
SPLINEFLAG.Final_Point  = 0x00010000;
SPLINEFLAG.Final_Target = 0x00020000;
SPLINEFLAG.Final_Angle  = 0x00040000;
SPLINEFLAG.Unknown19    = 0x00080000;           // exists; but unknown what it does
SPLINEFLAG.Cyclic       = 0x00100000;           // Movement by cycled spline
SPLINEFLAG.Enter_Cycle  = 0x00200000;           // Everytimes appears with cyclic flag in monster move packet; erases first spline vertex after first cycle done
SPLINEFLAG.Frozen       = 0x00400000;           // Will never arrive
SPLINEFLAG.Unknown23    = 0x00800000;
SPLINEFLAG.Unknown24    = 0x01000000;
SPLINEFLAG.Unknown25    = 0x02000000;          // exists; but unknown what it does
SPLINEFLAG.Unknown26    = 0x04000000;
SPLINEFLAG.Unknown27    = 0x08000000;
SPLINEFLAG.Unknown28    = 0x10000000;
SPLINEFLAG.Unknown29    = 0x20000000;
